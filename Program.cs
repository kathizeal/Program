        ...
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (userManager.LoginUser(inputUser, inputPassword))
                {
                    ...
                    //postManager.AddPost(new Post("a New Post", "This is my First Post", inputUser, userManager.CurrentUser.UserId));
                    
                    //Console.WriteLine("view all post");
                    //List<Post> _posts = postManager.ViewAllPost();
                    //count = 0;
                    //_posts.ForEach(post => DisplayPost(post, postManager.ViewPostComment(post.PostId)));
                    ...
                    switch (choice)
                    {
                        ...
                        case 4:
                            ...
                            if (_posts.Count != 0)
                            {
                                ...
                                innerchoice = Convert.ToInt32(Console.ReadLine());R
                        ...
                        case 5:
                            ...
                            if (post.Comments.Count != 0)
                            {
                                ...
                                /*postManager.addReply(comment, new Comment(comment.CommentId, replyComment, userManager.CurrentUser.UserName, userManager.CurrentUser.UserId));
                                //comment.Replys.Add(new Comment(comment.CommentId, replyComment, userManager.CurrentUser.UserName, userManager.CurrentUser.UserId));                           
                                break;*/
                                postManager.AddReply(post, comment, new Comment(post.PostId, replyComment, userManager.CurrentUser.UserName, userManager.CurrentUser.UserId, comment.CommentId));
                                break;
                            }
                            else
                            {
